...
/**
 * A capital S: Liberation Sans Bold, normalised to a cap height of 1000 and
 * condensed to 85.3%, which is the width the letters are drawn at in the
 * original artwork.
 */
const S =
...
export function SimpleSurgeryMark({ size = 15 }: { size?: number }) {
  return (
    <svg
      width={Math.round((size * 3363.8) / 1313)}
      height={size}
      viewBox="0 0 3363.8 1313"
      aria-hidden="true"
      focusable="false"
    ...
    >
      ...
      */}
      ...
      >
        <path d="M848.9 59.5L121.4 656.5L848.9 1253.5" />
        <path d="M2514.9 59.5L3242.4 656.5L2514.9 1253.5" />
      </g>
      <g fill="currentColor">
        <path d={S} transform="translate(959.7 156.5) scale(0.85343 1)" />
        <path d={S} transform="translate(1681.9 156.5) scale(0.85343 1)" />
      </g>
    </svg>
  )
}
